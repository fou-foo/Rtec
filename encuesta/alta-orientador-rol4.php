...
?>
<h4>Adicionando Orientador nivel 4</h4><br>
<FORM name="elmismo" action="alta-orientador-rol4-1.php"  method="POST">
...
<tr><td align="left">Nomina:
	...
	<tr><td align="left">Campus:
     <input type="text" name="campus" value="<?php echo $nivelUsuarioCoordinador;?>" size="13" maxlength="15" disabled="disabled"></tr></tr>
<?php endif; ?>
...
<tr><td align="left">Clave gen&eacute;rica:
     <input type="text" name="clave" value="dima4" size="13" maxlength="15" disabled="disabled"></tr></tr>
<TR>
...
<!-- Script con el form para dar de alta a un orientador nivel 4 por un orientador de nivel mayor a 4
-->
