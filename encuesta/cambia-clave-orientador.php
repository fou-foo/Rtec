...
<FORM name="elmismo" action="cambia-clave-orientador1.php"  method="POST">
<table border=0 width="400">
<tr>
	<th align="left">Nueva Clave:</th><input type="text" name="clave2" value="" size="15" maxlength="30">
</tr>
<TR>
...
<!-- Script con el form para cambiar la clave de acceso al sistema de un orientador-->
