...
if ($res['cuenta']) {
  $sql = "UPDATE orientadores SET clave='$clave' WHERE nomina='$orientador'";
   ...
   $sql = "INSERT INTO orientadores (nomina,clave,nivel, campus) VALUES ('$orientador','$clave', '4', '$campusC')";
}
$r = $con->prepare($sql);
$r->execute();
header("Location: servicios.php");
?>
<!-- Script para insertar orientadores nuevos en la tabla 'orientadores' con nivel 4 con una
     clave fija.
--> 
