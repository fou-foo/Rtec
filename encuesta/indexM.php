...
if (isset($_POST['usuario'])) {
	...
	$MM_redirectLoginSuccess = "serviciosM.php";
	...
	if (($claseUsuario[1] == 1) || ($claseUsuario[1] == 2)) {
		...
		if  ( $pop3->validate()) {
			...
			if (MD5($password) == $claseUsuario[6]) {
               ...
               $mensajeSalida="Usuario registrado pero la clave es inválida";
...
<body onload="clear();">
<CENTER>
<H2>Inventario de Fortalezas y Vulnerabilidades</H2>
</CENTER>
 ...
 <tr>
  ...
  <td width="584" height="216"><div align="center">
          ...
          <td >
			<table width="300" border="0" align="center" cellpadding="1" cellspacing="1" id="table2">
              ...
              <tr>
                ...
                <td height="22" colspan="2" ><div align="center" class="style2"><a href="https://tec.mx/es" target="_BLANK"><img src="graficos/tec.png" width="300" ></a></div><br></td>

              </tr>

              <tr>

                <td ><div align="right" class="style9">Usuario:<br>
              ...
              <tr>
                ...
                <td><div align="right" class="style9">Contrase&ntilde;a:</div></td>
...
<a href="http://dma.mty.itesm.mx/" target="_BLANK">Mejoramiento Académico</a>, 
<a href="http://www.itesm.mx/wps/wcm/connect/Campus/MTY/Monterrey/" target="_BLANK">Campus Monterrey</a><br>
 Si deseas información del instrumento enviar correo a: <a href="mailto:karlaurriola@itesm.mx">karlaurriola@itesm.mx</a>
